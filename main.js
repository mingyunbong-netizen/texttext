...
const modelsToLoad = [
    ...
    { name: 'shoes.glb',    scale: 10, positionX: -3.0, positionY: -1, positionZ: 0.0 }, 
    { name: 'bag.glb',      scale: 7, positionX: -3.0, positionY: -1, positionZ: 0.0 },
    ...
    { name: 'close.glb',    scale: 5, positionX: 2.0,  positionY: -1, positionZ: 0.0 },
    { name: 'glasses.glb',  scale: 20, positionX: 3.0,  positionY: -1, positionZ: 0.5 }, 
    { name: 'guard.glb',    scale: 10, positionX: 4.0,  positionY: -1, positionZ: 0.0 },
    { name: 'persimmon.glb',scale: 20, positionX: 5.0,  positionY: -1, positionZ: 0.0 },
];
